export const weatherSymbolMap: Record<string, string> = {
  clearsky_day: "01d",
  clearsky_night: "01n",
...
export const getWeatherSymbolURL = (symbolCode: string) => {
  return `https://nrkno.github.io/yr-weather-symbols/symbols/lightmode/${weatherSymbolMap[symbolCode]}.svg`;
};
